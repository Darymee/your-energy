import"./assets/main-CLpai_ej.js";import"./assets/vendor-pFq095uA.js";const h="https://your-energy.b.goit.study/api",l="favorites",o="./img/sprite.svg",e={quoteText:document.querySelector(".js-quote-text"),quoteAuthor:document.querySelector(".js-quote-author"),listContainer:document.querySelector(".js-favorites-list"),emptyMessage:document.querySelector(".js-favorites-empty")};document.addEventListener("DOMContentLoaded",()=>{g(),u()});async function g(){if(e.quoteText)try{const t=await fetch(`${h}/quote`);if(!t.ok)throw new Error("Failed to fetch quote");const{author:s,quote:n}=await t.json();e.quoteText.textContent=n,e.quoteAuthor.textContent=s}catch(t){console.error("Error getting quote:",t),e.quoteText.textContent="Your body can stand almost anything. It’s your mind that you have to convince.",e.quoteAuthor.textContent="Unknown"}}function d(){try{const t=localStorage.getItem(l);return t?JSON.parse(t):[]}catch(t){return console.error("Error parsing localStorage:",t),[]}}function u(){if(!e.listContainer)return;const t=d();t.length===0?(e.listContainer.innerHTML="",e.emptyMessage.classList.remove("is-hidden")):(e.emptyMessage.classList.add("is-hidden"),e.listContainer.innerHTML=p(t),v())}function p(t){return t.map(({_id:s,name:n,burnedCalories:c,time:a,bodyPart:r,target:f})=>`
