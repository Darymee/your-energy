var he=Object.defineProperty;var ee=e=>{throw TypeError(e)};var pe=(e,t,r)=>t in e?he(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var E=(e,t,r)=>pe(e,typeof t!="symbol"?t+"":t,r),te=(e,t,r)=>t.has(e)||ee("Cannot "+r);var h=(e,t,r)=>(te(e,t,"read from private field"),r?r.call(e):t.get(e)),M=(e,t,r)=>t.has(e)?ee("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r);var O=(e,t,r)=>(te(e,t,"access private method"),r);import{a as p,i as y}from"./vendor-pFq095uA.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const n of o.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function r(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(a){if(a.ep)return;a.ep=!0;const o=r(a);fetch(a.href,o)}})();(()=>{const e={openModalBtn:document.querySelector("[data-menu-open]"),closeModalBtn:document.querySelector("[data-menu-close]"),modal:document.querySelector("[data-menu]"),navLinks:document.querySelectorAll("[data-menu] .nav-link")};e.openModalBtn.addEventListener("click",t),e.closeModalBtn.addEventListener("click",t),e.navLinks.forEach(r=>r.addEventListener("click",t));function t(){e.modal.classList.toggle("is-open")}})();let H=window.location.pathname.split("/").pop()||"index.html",ae=H===""||H==="index.html"?"home":H.replace(".html","");const C=document.querySelectorAll(".nav-link");C.forEach(e=>{e.dataset.page===ae&&(e.classList.add("is-active"),e.classList.add("is-current"))});const U=document.querySelector(".nav-list"),j=document.querySelector(".nav-indicator");function P(e){if(!j||!U||!e)return;const t=U.getBoundingClientRect(),r=e.getBoundingClientRect(),s=r.left-t.left;j.style.width=r.width+"px",j.style.transform=`translateX(${s}px)`}let m=document.querySelector(".nav-link.is-active")||C[0];P(m);C.forEach(e=>{e.addEventListener("mouseenter",()=>{P(e),e!==m?m.classList.remove("is-current"):m.classList.add("is-current")}),e.addEventListener("click",t=>{if(e===m){t.preventDefault();return}if(e.dataset.page===ae){t.preventDefault(),m=e,m.classList.add("is-current"),P(m);return}C.forEach(r=>r.classList.remove("is-active","is-current")),e.classList.add("is-active","is-current"),m=e})});U.addEventListener("mouseleave",()=>{P(m),m.classList.add("is-current")});window.addEventListener("resize",()=>{P(m)});const ie=document.querySelector(".theme-switch .checkbox"),R=document.documentElement,ye=localStorage.getItem("theme"),be=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches,oe=ye||(be?"dark":"light");R.setAttribute("data-theme",oe);ie.checked=oe==="dark";function we(e){R.classList.add("theme-transition"),window.setTimeout(()=>{R.classList.remove("theme-transition")},400),e()}ie.addEventListener("change",e=>{const t=e.target.checked?"dark":"light";we(()=>{R.setAttribute("data-theme",t),localStorage.setItem("theme",t)})});const Y=document.querySelector(".anchor-button");function Le(e=1e3){const t=window.scrollY,r=performance.now();function s(a){const o=a-r,n=Math.min(o/e,1),d=1-Math.pow(1-n,3);window.scrollTo(0,t*(1-d)),n<1&&requestAnimationFrame(s)}requestAnimationFrame(s)}window.addEventListener("scroll",()=>{window.scrollY>300?Y.classList.add("show"):Y.classList.remove("show")});Y.addEventListener("click",e=>{e.preventDefault(),Le()});p.defaults.baseURL="https://your-energy.b.goit.study/api";p.defaults.headers.common["Content-Type"]="application/json";var x,ne,I,ce,f;class Se{constructor(){M(this,x);E(this,"totalPages",0);E(this,"currentPage",1);E(this,"limitPage",9);E(this,"filterType","Muscles");M(this,I,()=>{const r=window.innerWidth>=768?12:9;r!==this.limitPage&&(this.limitPage=r,this.currentPage=1)});M(this,f,t=>{var r,s;return console.error("API Error:",t),Promise.reject(((s=(r=t.response)==null?void 0:r.data)==null?void 0:s.message)||t.message||"An unexpected error occurred")});O(this,x,ne).call(this),window.addEventListener("resize",h(this,I))}incrementPage(){this.currentPage<this.totalPages&&(this.currentPage+=1)}decrementPage(){this.currentPage>1&&(this.currentPage-=1)}changeSearchType(t){this.filterType=t,this.currentPage=1}hasMorePages(){return this.currentPage<this.totalPages}async getDataByFilter(){try{const t=await p.get("/filters",{params:O(this,x,ce).call(this)});return this.totalPages=t.data.totalPages,t.data}catch(t){return h(this,f).call(this,t)}}async getExercises(t={},r=1,s=10){try{const a={...t,page:r,limit:s};return(await p.get("/exercises",{params:a})).data}catch(a){return h(this,f).call(this,a)}}async getExerciseByCategory(t,r,s=1,a=10){try{const n={Muscles:"muscles","Body parts":"bodypart",Equipment:"equipment"}[t];if(!n)throw new Error(`Unknown filter type: ${t}`);const d={[n]:r.toLowerCase(),page:s,limit:a};return(await p.get("/exercises",{params:d})).data}catch(o){return h(this,f).call(this,o)}}async getExerciseById(t){try{return(await p.get(`/exercises/${t}`)).data}catch(r){return h(this,f).call(this,r)}}async rateExercise(t,r,s,a=""){try{if(r<1||r>5)throw new Error("Rating must be between 1 and 5");return(await p.patch(`/exercises/${t}/rating`,{rate:r,email:s,review:a})).data}catch(o){return h(this,f).call(this,o)}}async getQuote(){try{return(await p.get("/quote")).data}catch(t){return h(this,f).call(this,t)}}async subscribe(t){try{return await p.post("/subscription",{email:t})}catch(r){return h(this,f).call(this,r)}}}x=new WeakSet,ne=function(){const{matches:t}=window.matchMedia("(max-width: 767px)");this.limitPage=t?9:12},I=new WeakMap,ce=function(){return{filter:this.filterType,page:this.currentPage,limit:this.limitPage}},f=new WeakMap;const c=new Se,_={form:document.querySelector(".footer-form")},xe=async e=>{e.preventDefault();const t=e.target.elements.email.value.trim(),r=/^\w+(\.\w+)?@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/;if(!t){y.info({message:"Email is required",position:"topRight"});return}if(!r.test(t)){y.info({message:"Invalid email format",position:"topRight"});return}try{const s=await c.subscribe(t);if(s.status===201){y.success({message:s.data.message,position:"topRight"}),_.form.reset();return}}catch(s){y.error({message:s,position:"topRight"}),_.form.reset()}};_.form.addEventListener("submit",xe);const $={FAVORITES:"favorites",UI_THEME:"ui-theme",LAST_SESSION:"last_session",DAILY_QUOTE:"daily_quote"},V=()=>{try{const e=localStorage.getItem($.FAVORITES);return e?JSON.parse(e):[]}catch(e){return console.error("Error parsing favorites from localStorage:",e),[]}},A=e=>V().includes(e),Ee=e=>{try{const t=V();t.includes(e)||(t.push(e),localStorage.setItem($.FAVORITES,JSON.stringify(t)))}catch(t){console.error("Error adding favorite:",t)}},le=e=>{try{const r=V().filter(s=>s!==e);localStorage.setItem($.FAVORITES,JSON.stringify(r))}catch(t){console.error("Error removing favorite:",t)}},qe=e=>A(e)?(le(e),!1):(Ee(e),!0),Te=e=>{if(!e)return!1;const t=new Date(e),r=new Date;return t.getFullYear()===r.getFullYear()&&t.getMonth()===r.getMonth()&&t.getDate()===r.getDate()},Pe=()=>{try{const e=localStorage.getItem($.DAILY_QUOTE);if(!e)return null;const t=JSON.parse(e);return Te(t.timestamp)?t:null}catch(e){return console.error("Error getting daily quote from localStorage:",e),null}},Be=(e,t)=>{try{const r={quote:e,author:t,timestamp:Date.now()};localStorage.setItem($.DAILY_QUOTE,JSON.stringify(r))}catch(r){console.error("Error saving daily quote to localStorage:",r)}},v="/your-energy/img/sprite.svg";function N(e){return e?e.charAt(0).toUpperCase()+e.slice(1):""}function $e(e){const t=Math.round(Math.max(0,Math.min(5,Number(e)||0))),r=Array(t).fill(`<svg class="full" width="18" height="18">
    ...
    `},exerciseModal({_id:e,name:t,rating:r,gifUrl:s,target:a,bodyPart:o,equipment:n,popularity:d,burnedCalories:g,description:u,time:w}){const L=$e(r);return`
