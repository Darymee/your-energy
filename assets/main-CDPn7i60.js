      ...
      <li class="favorites-item" data-id=${e}>
        ...
        <ul class="card-info-list">
          ...
          <li class="card-info-item">
              ...
              <span class="info-value">${H(i)}</span>
          </li>
          <li class="card-info-item">
              <span class="info-label">Target:</span>
              <span class="info-value">${H(a)}</span>
          </li>
        </ul>
      </li>
    `},exerciseModal({_id:e,name:t,rating:r,gifUrl:s,target:i,bodyPart:a,equipment:o,popularity:d,burnedCalories:u,description:S,time:h}){const L=Le(r);return`
